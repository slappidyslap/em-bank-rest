...
RESTFul Backend приложение, разработанное на Spring Boot, предназначенное для управления
...
Приложение задеплоено на [Render.com](https://render.com/)
и доступно по адресу: [https://em-bank-rest.onrender.com/swagger-ui.html](https://em-bank-rest.onrender.com/swagger-ui.html)

## CI/CD

После каждого push и pull request в этот репозиторий
автоматически запускаются тесты, которые проверяют бизнес-логику приложения.

Если все тесты проходят **успешно** и если в репозиторий изначально сделали **push**,
происходит:
* Публикация отчета по покрытию кода тестами сгенерированный JaCoCo в: [https://slappidyslap.github.io/em-bank-rest/jacoco](https://slappidyslap.github.io/em-bank-rest/jacoco)
* Деплой обновленной версии приложения на Render.com через webhook.
...
2. Определите переменные окружения для подключения к БД.
Не забудьте выполнить команду `export` для каждой переменной в вашей текущей сессии терминала
...
После успешного запуска проекта документация OpenAPI доступна в: http://&lt;address&gt;/swagger-ui.html
Где &lt;address&gt; адрес, где запущено приложение.

В данном разделе, вы найдете все эндпоинты
для аутентификации, регистрации, управления пользователями, картами и переводами.
...
После запуска тестов полный HTML отчет о покрытии кода доступен по следующему пути: `./target/site/jacoco/index.html`

Кроме этого отчет так же опубликован в: [https://slappidyslap.github.io/em-bank-rest/jacoco](https://slappidyslap.github.io/em-bank-rest/jacoco)

## Полезные ссылки

[https://habr.com/ru/articles/818489/](https://slappidyslap.github.io/em-bank-rest/jacoco)

[https://stackoverflow.com/questions/27767264/how-to-dockerize-a-maven-project-how-many-ways-to-accomplish-it](https://stackoverflow.com/questions/27767264/how-to-dockerize-a-maven-project-how-many-ways-to-accomplish-it)

[https://github.com/jwtk/jjwt?tab=readme-ov-file#quickstart](https://github.com/jwtk/jjwt?tab=readme-ov-file#quickstart)
