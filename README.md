...
и доступно по адресу: https://em-bank-rest.onrender.com/swagger-ui.html
...
происходит:
* Публикация отчета по покрытию кода тестами сгенерированный JaCoCo в: https://slappidyslap.github.io/em-bank-rest/jacoco
...
Кроме этого отчет так же опубликован в: https://slappidyslap.github.io/em-bank-rest/jacoco
